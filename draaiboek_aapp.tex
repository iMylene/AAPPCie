...
Takenlijst voor de functies binnen de commissie.
\section{Voorzitter}
De voorzitter leidt de vergaderingen en hoort de leden de motiveren, zodat taken worden uitgevoerd.
	\subsection{Vergaderen}\label{Vergaderen}
	...
	\subsection{Motiveren}\label{Motiveren}
